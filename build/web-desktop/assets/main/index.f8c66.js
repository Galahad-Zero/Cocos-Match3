window.__require = function e(t, n, r) {
  ...
  GameMgr: [ function(require, module, exports) {
    ...
    let GameMgr = class GameMgr extends cc.Component {
      ...
      onGameWin() {
        ...
        saveData.maxLevelId < this.playPanel.getLevelConfig().id && Utils_1.setLocalData(const_1.UserSaveDataName, {
  ...
  HotUpdateMgr: [ function(require, module, exports) {
    ...
    function versionCompareHandle(versionA, versionB) {
      cc.log("\u70ed\u66f4\u65b0\u7248\u672c\u53f7\u6bd4\u8f83: version A is " + versionA + ", version B is " + versionB);
    ...
    let HotUpdateMgr = class HotUpdateMgr extends cc.Component {
      ...
      onLoad() {
        ...
        this._storagePath = (jsb.fileUtils ? jsb.fileUtils.getWritablePath() : "/") + "match-3-remote-asset";
      ...
      checkCb(event) {
        ...
        switch (event.getEventCode()) {
         ...
         case jsb.EventAssetsManager.NEW_VERSION_FOUND:
          this.hotUpdatePanel.setInfo("\u53d1\u73b0\u65b0\u7248\u672c\uff0c\u8bf7\u5c1d\u8bd5\u66f4\u65b0... (\u603b\u5b57\u8282\u6570: " + this._am.getTotalBytes() + "bytes)");
      ...
      updateCb(event) {
        ...
        switch (event.getEventCode()) {
         ...
         case jsb.EventAssetsManager.UPDATE_PROGRESSION:
          ...
          msg && this.hotUpdatePanel.setInfo("Updated file: " + msg);
          break;
         ...
         case jsb.EventAssetsManager.ERROR_UPDATING:
          this.hotUpdatePanel.setInfo("\u8d44\u6e90\u66f4\u65b0\u9519\u8bef: " + event.getAssetId() + ", " + event.getMessage());
          break;
    ...
    __decorate([ property(cc.Asset) ], HotUpdateMgr.prototype, "manifestUrl", void 0);
    __decorate([ property(HotUpdatePanel_1.default) ], HotUpdateMgr.prototype, "hotUpdatePanel", void 0);
    HotUpdateMgr = __decorate([ ccclass ], HotUpdateMgr);
    exports.default = HotUpdateMgr;
    cc._RF.pop();
  }, {
    "./HotUpdatePanel": "HotUpdatePanel"
  } ],
  HotUpdatePanel: [ function(require, module, exports) {
    "use strict";
    ...
    __decorate([ property(cc.Label) ], HotUpdatePanel.prototype, "infoLabel", void 0);
    __decorate([ property(cc.Label) ], HotUpdatePanel.prototype, "fileLabel", void 0);
    __decorate([ property(cc.Label) ], HotUpdatePanel.prototype, "byteLabel", void 0);
    __decorate([ property(cc.Node) ], HotUpdatePanel.prototype, "checkBtn", void 0);
    __decorate([ property(cc.Node) ], HotUpdatePanel.prototype, "updateBtn", void 0);
    __decorate([ property(cc.Node) ], HotUpdatePanel.prototype, "retryBtn", void 0);
    HotUpdatePanel = __decorate([ ccclass ], HotUpdatePanel);
  ...
  LevelView: [ function(require, module, exports) {
    ...
    let LevelView = class LevelView extends cc.Component {
      onLoad() {
        ...
        hasSaveData || Utils_1.setLocalData(const_1.UserSaveDataName, {
          maxLevelId: 0
        });
      }
      start() {
      ...
      adjustLevelBtns() {
        ...
        levelBtns.forEach(levelBtn => {
          ...
          levelInfo.id <= maxLevelId + 1 ? levelBtn.setBtnActive(true) : levelBtn.setBtnActive(false);
        });
      }
      getAllLevelBtns() {
      ...
      getContiguousBlocks(location, mapInfo, excludeLocations) {
        ...
        rowSet.forEach(row => {
          ...
          for (let i = 1; i < rowLocations.length; i++) {
            ...
            if (location.column - rowLocations[i - 1].column === 1) linkedValidRowLocations.push(location); else {
              linkedValidRowLocations.length >= 3 && validContiguousLocations.push(...linkedValidRowLocations);
        ...
        columnSet.forEach(column => {
          ...
          let linkedValidColumnLocations = [ columnLocations[0] ];
          for (let i = 1; i < columnLocations.length; i++) {
            const location = columnLocations[i];
            if (location.row - columnLocations[i - 1].row === 1) linkedValidColumnLocations.push(location); else {
              linkedValidColumnLocations.length >= 3 && validContiguousLocations.push(...linkedValidColumnLocations);
  ...
  const: [ function(require, module, exports) {
    ...
    exports.EntryLevelEvent = exports.UserSaveDataName = exports.UserSettingItemName = void 0;
    exports.UserSettingItemName = "UserSetting";
    exports.UserSaveDataName = "UserSaveData";
    exports.EntryLevelEvent = "EntryLevelEvent";
    cc._RF.pop();
  }, {} ]
}, {}, [ "AudioMgr", "GameSetting", "HotUpdateMgr", "HotUpdatePanel", "Menu", "Utils", "const", "GameConst", "GameMgr", "GameTypes", "PlayPanel", "TouchHandler", "BaseBlock", "BlockMgr", "BlockStyleProperty", "EliminateUtils", "GameFsm", "GameUtils", "Grid", "SpineProperty", "SpineUtils", "BaseEffect", "EffectMgr", "GameFinPanel", "GameUI", "LevelBtn", "LevelMenu", "LevelView", "ConfigTypes" ]);
