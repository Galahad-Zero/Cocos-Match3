...
let GameMgr = class GameMgr extends cc.Component {
    ...
    onTouchEvent(event) {
        ...
        if (type === TouchHandler_1.TouchDetailEventType.click) {
            this.onClickBlock(location);
        }
        else if (type === TouchHandler_1.TouchDetailEventType.drag) {
            this.onDragBlock(location, event.direction || GameConst_1.Direction.NONE);
        }
    }
    // 点击方块
    onClickBlock(location) {
        ...
        // 点击方块
        const isSameBlock = this._selectedLocation.row === location.row &&
    ...
    onChecking() {
        ...
        if (this._gameCheckInfo.swapBlocks) {
            ...
            if (blockConfig1.special === GameTypes_1.BlockSpecialType.SPECIAL_BOOM) {
                // 特殊炸弹方块，直接标记为可消除
                this._gameCheckInfo.canEliminateCheckInfos.push({
            ...
            if (blockConfig2.special === GameTypes_1.BlockSpecialType.SPECIAL_BOOM) {
                // 特殊炸弹方块，直接标记为可消除
                this._gameCheckInfo.canEliminateCheckInfos.push({
    ...
    onEliminating() {
        // 获取已经消除的方块
        const alreadyEliminateBlocks = this._gameCheckInfo.canEliminateCheckInfos.reduce((acc, info) => {
    ...
    checkGameOver() {
        ...
        if (curScore >= targetScore) {
            // 得分大于等于目标分数，游戏胜利
            this._gameFsm.changeState(GameFsm_1.GameState.GAME_WIN);
        }
        // 检查游戏是否结束, 还有步数则继续游戏，否则游戏结束
            ...
            // 没有步数，游戏结束
            this._gameFsm.changeState(GameFsm_1.GameState.GAME_OVER);
        }
    }
    backToLevelSelect() {
...
], GameMgr.prototype, "playPanel", void 0);
__decorate([
    property(GameUI_1.default)
], GameMgr.prototype, "gameUI", void 0);
__decorate([
    property(TouchHandler_1.default)
], GameMgr.prototype, "touchHandler", void 0);
__decorate([
    property(BlockMgr_1.default)
], GameMgr.prototype, "blockMgr", void 0);
__decorate([
    property(EffectMgr_1.default)
], GameMgr.prototype, "effectMgr", void 0);
__decorate([
    property(AudioMgr_1.default)
], GameMgr.prototype, "audioMgr", void 0);
GameMgr = __decorate([
    ccclass
], GameMgr);
